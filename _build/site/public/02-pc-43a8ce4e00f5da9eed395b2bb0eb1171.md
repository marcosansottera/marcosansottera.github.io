...
Il floppy disk (chiamato anche dischetto o floppy) è un supporto di
memoria digitale di tipo magnetico inventato dalla IBM nel 1967, molto
diffuso tra la fine degli anni settanta e gli anni novanta. Essendo
stato per decenni il dispositivo di memorizzazione esterna più usato,
l'immagine del floppy disk venne impiegata nell'interfaccia grafica di
programmi e siti web per simboleggiare il comando per il salvataggio
dei dati e questa funzione rimase anche quando il loro impiego come
supporto fisico divenne obsoleto.

![Floppy Disk meme](./floppy_meme.jpeg)
